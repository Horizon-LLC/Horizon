...
def mapped_column(
    ...
    **kw: Any,
    ...
    :param default: Passed directly to the
     ...
     constructor within the generated ``__init__.py()`` method.
     ...
     places, both the ``__init__.py()`` method as well as the
     ...
     ``__init__.py()`` is called, which is the same value that the Core
    ...
    :param init: Specific to :ref:`orm_declarative_native_dataclasses`,
     specifies if the mapped attribute should be part of the ``__init__.py()``
    ...
    :param kw_only: Specific to
     :ref:`orm_declarative_native_dataclasses`, indicates if this field
     should be marked as keyword-only when generating the ``__init__.py()``.
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    Dataclass ``__init__.py()`` constructor.
