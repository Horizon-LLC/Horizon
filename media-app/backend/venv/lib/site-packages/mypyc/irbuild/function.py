...
def generate_singledispatch_callable_class_ctor(builder: IRBuilder) -> None:
    """Create an __init__.py that sets registry and dispatch_cache to empty dicts"""
    line = -1
    class_ir = builder.fn_info.callable_class.ir
    with builder.enter_method(class_ir, "__init__.py", bool_rprimitive):
        ...
        # the generated C code seems to expect that __init__.py returns a char, so just return 1
