...
class Table(
    ...
    if not typing.TYPE_CHECKING:
        ...
        # __new__.  apply typing to the __init__.py method normally
    ...
    def __init__(
        ...
        *args: SchemaItem,
        ...
        # used by __new__ to bypass __init__.py
        _no_init: bool = True,
        ...
        **kw: Any,
        ...
        """  # noqa: E501
        if _no_init:
            # don't run __init__.py from __new__ by default;
            # __new__ has a specific place that __init__.py is called
            return
