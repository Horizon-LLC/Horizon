...
def process_options(
    ...
    add_invertible_flag(
        ...
        default=True,
        help="Support namespace packages (PEP 420, __init__.py.py-less)",
        group=imports_group,
    )
    ...
    # packages even without __init__.py.py.  May be repeated.
    parser.add_argument(
    ...
    if options.explicit_package_bases and not options.namespace_packages:
        parser.error(
            ...
            "examining __init__.py.py's is sufficient to determine module names for files"
        )
