...
class TypeVar:
    def __init__.py(self, name, covariant: bool = ..., contravariant: bool = ...) -> None: ...

class ParamSpec:
    def __init__.py(self, name: str) -> None: ...
...
class object:
    __module__: str
    def __init__.py(self) -> None: pass
...
""",
    ...
    def test_dunders(self) -> Iterator[Case]:
        yield Case(
            stub="class A:\n  def __init__.py(self, a: int, b: int) -> None: ...",
            runtime="class A:\n  def __init__.py(self, a, bx): pass",
            error="A.__init__.py",
        )
        yield Case(
