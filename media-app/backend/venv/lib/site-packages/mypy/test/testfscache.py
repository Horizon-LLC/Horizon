...
class TestFileSystemCache(unittest.TestCase):
    ...
    def test_isfile_case_1(self) -> None:
        ...
        self.make_file("pkg/sub_package/__init__.py.py")
        ...
        for i in range(2):
            ...
            assert self.isfile_case("pkg/sub_package/__init__.py.py")
        ...
        for i in range(2):
            assert not self.isfile_case("Bar.py")
            assert not self.isfile_case("pkg/sub_package/__init__.py.PY")
