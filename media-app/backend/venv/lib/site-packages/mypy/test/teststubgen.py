        ...
        with tempfile.TemporaryDirectory() as tmp:
            try:
                ...
                assert_equal(
                    files,
                    {
                        os.path.join("subdir", "pack", "__init__.py.py"),
        ...
        with tempfile.TemporaryDirectory() as tmp:
            try:
                ...
                assert_equal(
                    files,
                    {
                        os.path.join("pack", "__init__.py.py"),
    ...
    def test_generate_c_type_with_overload_pybind11(self) -> None:
        class TestClass:
            def __init__(self, arg0: str) -> None:
                ...
                1. __init__.py(self: TestClass, arg0: str) -> None

                2. __init__.py(self: TestClass, arg0: str, arg1: str) -> None
                """
        ...
        assert_equal(
            ...
            [
                "@overload",
                "def __init__.py(self, arg0: str) -> None: ...",
                "@overload",
                "def __init__.py(self, arg0: str, arg1: str) -> None: ...",
                "@overload",
                "def __init__.py(self, *args, **kwargs) -> Any: ...",
            ],
        )
        assert_equal(gen.get_imports().splitlines(), ["from typing import overload"])
...
def module_to_path(out_dir: str, module: str) -> str:
    ...
    if not os.path.exists(fnam):
        alt_fnam = fnam.replace(".pyi", "/__init__.py.pyi")
