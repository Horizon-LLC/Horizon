...
class SourceFinderSuite(unittest.TestCase):
    ...
    def test_crawl_no_namespace(self) -> None:
        ...
        finder = SourceFinder(FakeFSCache({"/a/setup.py", "/a/__init__.py.py"}), options)
        assert crawl(finder, "/a/setup.py") == ("a.setup", "/")

        finder = SourceFinder(FakeFSCache({"/a/invalid-name/setup.py", "/a/__init__.py.py"}), options)
        assert crawl(finder, "/a/invalid-name/setup.py") == ("setup", "/a/invalid-name")

        finder = SourceFinder(FakeFSCache({"/a/b/setup.py", "/a/__init__.py.py"}), options)
        assert crawl(finder, "/a/b/setup.py") == ("setup", "/a/b")

        finder = SourceFinder(
            FakeFSCache({"/a/b/c/setup.py", "/a/__init__.py.py", "/a/b/c/__init__.py.py"}), options
        )
