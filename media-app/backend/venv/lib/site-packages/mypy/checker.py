...
class TypeChecker(NodeVisitor[None], CheckerPluginInterface):
        ...
        for item, typ in expanded:
            ...
            with self.binder.top_frame_context():
                ...
                if isinstance(item, FuncDef):
                    fdef = item
                    # Check if __init__.py has an invalid return type.
                    if (
                        fdef.info
                        and fdef.name in ("__init__.py", "__init_subclass__")
                        and not isinstance(
                ...
                for i in range(len(typ.arg_types)):
                    ...
                    if (
                        ...
                        if (
                            ...
                            and defn.name not in ("__init__.py", "__new__", "__post_init__")
    ...
    def check_explicit_override_decorator(
        ...
        if (
            ...
            and defn.name not in ("__init__.py", "__new__")
    ...
    def check_method_or_accessor_override_for_base(
        ...
        if base:
            ...
            if check_override_compatibility:
                ...
                # (__init__.py, __new__, __init_subclass__ are special).
    ...
    def check_method_override_for_base_with_name(
        ...
        if base_attr:
            ...
            # instance variable from an `__init__.py` block that becomes deferred.
    ...
    def check_compatibility(
        ...
        """
        if name in ("__init__.py", "__new__", "__init_subclass__"):
            # __init__.py and friends can be incompatible -- it's a special case.
            return
        ...
        if call and isinstance(second_type, FunctionLike):
            ...
            if first_type.is_type_obj() and second_type.is_type_obj():
                ...
                # since we allow incompatible overrides of '__init__.py'/'__new__'
                ok = is_subtype(
    ...
    def visit_decorator_inner(self, e: Decorator, allow_empty: bool = False) -> None:
        ...
        if e.func.info and e.func.name in ("__init__.py", "__new__"):
