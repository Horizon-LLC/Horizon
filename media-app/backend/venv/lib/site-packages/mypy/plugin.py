...
class SemanticAnalyzerPluginInterface:
    ...
    def add_plugin_dependency(self, trigger: str, target: str | None = None) -> None:
        ...
        For example, the dataclass plugin adds a generated __init__.py method with
        ...
        the subclasses (and thus regenerate __init__.py methods).
...
class Plugin(CommonPluginApi):
    ...
    def __init__(self, options: Options) -> None:
        ...
        # This can't be set in __init__.py because it is executed too soon in build.py.
    ...
    def get_method_signature_hook(
        ...
        Python dunder methods except __init__.py and __new__ (use get_function_hook to customize
