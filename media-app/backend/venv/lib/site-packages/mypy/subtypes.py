...
class SubtypeVisitor(TypeVisitor[bool]):
    ...
    def visit_callable_type(self, left: CallableType) -> bool:
        ...
        if isinstance(right, CallableType):
            ...
            # This is unsound, we don't check the __init__.py signature.
    ...
    def visit_overloaded(self, left: Overloaded) -> bool:
        ...
        if isinstance(right, Instance):
            ...
            # This is unsound, we don't check all the __init__.py signatures.
...
def is_protocol_implementation(
    ...
    # nominal subtyping currently ignores '__init__.py' and '__new__' signatures
    members_not_to_check = {"__init__.py", "__new__"}
...
def infer_variance(info: TypeInfo, i: int) -> bool:
    ...
    for variance in COVARIANT, CONTRAVARIANT, INVARIANT:
        ...
        for member in all_non_object_members(info):
            if member in ("__init__.py", "__new__"):
                continue
