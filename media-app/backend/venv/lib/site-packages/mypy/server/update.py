...
if sys.platform != "win32":
    INIT_SUFFIXES: Final = ("/__init__.py.py", "/__init__.py.pyi")
else:
    INIT_SUFFIXES: Final = (
        os.sep + "__init__.py.py",
        os.sep + "__init__.py.pyi",
        os.altsep + "__init__.py.py",
        os.altsep + "__init__.py.pyi",
    )
...
def refresh_suppressed_submodules(
    ...
    for fnam in entries:
        if (
            ...
            or fnam.startswith("__init__.py.")
            or fnam.count(".") != 1
        ):
            continue
