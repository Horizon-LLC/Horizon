...
def verify_typeinfo(
    ...
    # Special-case the __init__.py method for Protocols and the __new__ method for TypedDicts
    #
    # TODO: On Python <3.11, __init__.py methods on Protocol classes
    # are silently discarded and replaced.
    # However, this is not the case on Python 3.11+.
    # Ideally, we'd figure out a good way of validating Protocol __init__.py methods on 3.11+.
    if stub.is_protocol:
        to_check.discard("__init__.py")
