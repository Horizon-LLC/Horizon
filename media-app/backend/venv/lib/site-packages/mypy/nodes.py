...
class MypyFile(SymbolNode):
    ...
    # Does this represent an __init__.py.pyi stub with a module __getattr__
    ...
    def is_package_init_file(self) -> bool:
        return len(self.path) != 0 and os.path.basename(self.path).startswith("__init__.py.")
...
class OverloadedFuncDef(FuncBase, SymbolNode, Statement):
    ...
    def deserialize(cls, data: JsonDict) -> OverloadedFuncDef:
        ...
        if data.get("impl") is not None:
            ...
            # set line for empty overload items, as not set in __init__.py
            if len(res.items) > 0:
...
class FuncDef(FuncItem, SymbolNode, Statement):
    ...
    # Note that all __init__.py args must have default values
    def __init__(
        self,
...
class Var(SymbolNode):
    ...
    def deserialize(cls, data: JsonDict) -> Var:
        ...
        v = Var(name, type)
        v.is_ready = False  # Override True default set in __init__.py
