...
def analyze_instance_member_access(
    ...
    if name == "__init__.py" and not mx.is_super:
        # Accessing __init__.py in statically typed code would compromise
...
def analyze_class_attribute_access(
    ...
    *,
    ...
    # If a final attribute was declared on `self` in `__init__.py`, then it
...
def add_class_tvars(
    ...
    # without applied type arguments, this matches the behavior of __init__.py().
...
def type_object_type(info: TypeInfo, named_type: Callable[[str], Instance]) -> ProperType:
    ...
    where ... are argument types for the __init__.py/__new__ method (without the self
    argument). Also, the fallback type will be 'type' instead of 'function'.
    """

    # We take the type from whichever of __init__.py and __new__ is first
    # in the MRO, preferring __init__.py if there is a tie.
    init_method = info.get("__init__.py")
    ...
    if init_index < new_index:
        ...
        # Otherwise prefer __init__.py in a tie. It isn't clear that this
        # is the right thing, but __new__ caused problems with
        # typeshed (#5647).
        method = init_method.node
        is_new = False
    # Construct callable type based on signature of __init__.py. Adjust
