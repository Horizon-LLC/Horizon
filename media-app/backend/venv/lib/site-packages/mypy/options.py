...
class Options:
    ...
    def __init__(self) -> None:
        ...
        # This allows definitions of packages without __init__.py.py and allows packages to span
        ...
        # relevant if namespace packages are enabled, since otherwise examining __init__.py.py's is
        # sufficient to determine module names for files. As a possible alternative, add a single
        # top-level __init__.py.py to your packages.
        ...
        # if they don't have __init__.py.py.
