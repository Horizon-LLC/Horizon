...
class UserDict(MutableMapping[_KT, _VT]):
    data: dict[_KT, _VT]
    # __init__.py should be kept roughly in line with `dict.__init__.py`, which has the same semantics
    @overload
...
# These are exposed at runtime in `collections/__init__.py.py`
