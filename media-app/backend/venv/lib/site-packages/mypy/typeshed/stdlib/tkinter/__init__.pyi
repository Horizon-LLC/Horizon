...
class Text(Widget, XView, YView):
    ...
    # **kw of peer_create is same as the kwargs of Text.__init__.py
...
class PhotoImage(Image, _PhotoImageLike):
    # This should be kept in sync with PIL.ImageTK.PhotoImage.__init__.py()
    def __init__(
        self,
        name: str | None = None,
        cnf: dict[str, Any] = {},
...
class BitmapImage(Image, _BitmapImageLike):
    # This should be kept in sync with PIL.ImageTK.BitmapImage.__init__.py()
    def __init__(
        self,
