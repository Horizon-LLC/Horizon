...
class _GeneratorContextManager(AbstractContextManager[_T_co, bool | None], ContextDecorator):
    # __init__.py and all instance attributes are actually inherited from _GeneratorContextManagerBase
...
if sys.version_info >= (3, 10):
    ...
    class _AsyncGeneratorContextManager(AbstractAsyncContextManager[_T_co, bool | None], AsyncContextDecorator):
        # __init__.py and these attributes are actually defined in the base class _GeneratorContextManagerBase,
