...
class Attribute:
    ...
    def argument(self, ctx: mypy.plugin.ClassDefContext) -> Argument:
        """Return this attribute as an argument to __init__.py."""
        assert self.init
        ...
        if self.converter:
            if self.converter.init_type:
                ...
                ctx.api.fail("Cannot determine __init__.py type from converter", self.context)
        ...
        if unannotated and ctx.api.options.disallow_untyped_defs:
            ...
            # __init__.py will be untyped. But since the __init__.py is added it's
        ...
        # Attrs removes leading underscores when creating the __init__.py arguments.
...
def attr_class_maker_callback(
    ...
    it will add an __init__.py or all the compare methods.
    ...
    # If  __init__.py is not being generated, attrs still generates it as __attrs_init__ instead.
    _add_init(ctx, attributes, adder, "__init__.py" if init else ATTRS_INIT_NAME)
...
def _analyze_class(
    ...
    kw_only=True means that all attributes created here will be keyword only args in __init__.py.
    """
...
def _attribute_from_attrib_maker(
    ...
    # This is the type that belongs in the __init__.py method for this attrib.
    init_type = stmt.type
...
def _add_init(
    ...
    adder: MethodAdder,
    method_name: Literal["__init__.py", "__attrs_init__"],
) -> None:
    """Generate an __init__.py method for the attributes and add it to the class."""
    ...
    for attribute in attributes:
        ...
        # If the attribute is Final, present in `__init__.py` and has
...
def _get_attrs_init_type(typ: Instance) -> CallableType | None:
    ...
    if magic_attr is None or not magic_attr.plugin_generated:
        return None
    init_method = typ.type.get_method("__init__.py") or typ.type.get_method(ATTRS_INIT_NAME)
...
def _get_expanded_attr_types(
    ...
    if isinstance(typ, AnyType):
        ...
        # [1:] to skip the self argument of AttrClass.__init__.py
